  ...
  return (
    <div>
      ...
      {mm1.map((send)=>{
            return(
      <div className="">
        <div className="imgbg" style={{backgroundImage:`url(${send.imges})`}}>
                ...
                <div className="col-md-4">
                  <div className="box1">
                    ...
                    <div className="tripPrice py-4 bg-primary text-white" style={{borderBottom:'1px solid black' , }}>
                      ...
                      <div className="Date d-flex align-items-center justify-content-between  p-2 " style={{backgroundColor:'#f9f9f9'}}>
                    ...
                    />
                      ...
                      <div className="Adults  d-flex justify-content-between align-items-center py-4 p-2" style={{backgroundColor:'#f9f9f9' , borderTop:'1px solid black'}}>
                        ...
                        <div className="AdultsValue d-flex justify-content-between mx-2" style={{width:'150px', fontSize:'22px'}}>
                          ...
                          <input className='tt' type="text" value={adult} onChange={(e) => { setAdult(e.target.value) }} style={{ color: "black" }}></input>
                     ...
                     <div className="Adults  d-flex justify-content-between align-items-center py-4 p-2" style={{backgroundColor:'#f9f9f9' , borderTop:'1px solid black'}}>
                        ...
                        <div className="AdultsValue d-flex justify-content-between mx-2" style={{width:'150px', fontSize:'22px'}}>
                          ...
                          <input className='tt' type="text" value={children} onChange={(e) => { setChildren(e.target.value) }} style={{ color: "black" }}></input>                          <span onClick={() => handleIncrementChildren()} style={{cursor:"pointer"}}>+</span>
                        </div>
                      </div> 
